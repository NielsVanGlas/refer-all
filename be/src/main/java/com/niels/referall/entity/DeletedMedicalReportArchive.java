...
public class DeletedMedicalReportArchive extends CommonEntity {
    ...
    public DeletedMedicalReportArchive(MedicalReport medicalReport) {
        this.patient = medicalReport.getPatient();
        this.doctor = medicalReport.getDoctor();
        ...
        this.sha256 = medicalReport.getSha256();
